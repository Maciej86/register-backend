          ...
          <tr>
            <td>
              <table style="width: 80%; margin: 20px auto; padding: 10px; background-color: rgb(250,250,250); color: rgb(69,69,69); font-size: 16px; text-align: center; border-radius: 10px;">
                ...
                <tr>
                  <td><p style="margin: 15px 0; line-height: 1.5;">${t("password_reset.send_message")}</p></td>
                </tr>
                <tr>
                  <td style="padding: 40px 0px;"><a href="${url}" target="_blank" style="padding: 18px 38px; background-color: rgb(169, 223, 216); color: rgb(67, 99, 94); font-size: 18px; text-decoration: none; border-radius: 5px;"><strong>${t("password_reset.button_password_reset")}</strong></a></td>
                </tr>
                <tr>
