...
export const register_system_user = async (username, hashedPassword) => {
  try{
    await pool.query(
      `INSERT INTO system_users (first_name, last_name, email, password_hash, system_user_role, theme, is_active, created_at, updated_at) VALUES (?, ?, ?, ?, 'developer', "defaultTheme", true, NOW(), NOW())`,
